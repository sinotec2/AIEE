...
- 如何安裝並設定它以支援 Claude Code 與 Claude Desktop
- 你的 AI 代理有哪些工具可用
...
### [​配置](https://developers.deepl.com/docs/getting-started/deepl-mcp-server#configuration)
...
- **自己打造：**請關注[MCP 伺服器手冊](https://developers.deepl.com/docs/learning-how-tos/examples-and-guides/deepl-mcp-server-how-to-build-and-use-translation-in-llm-applications)從零開始建立自訂的 MCP 伺服器
