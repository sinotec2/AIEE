...
以下是對RAG的名詞解釋和常見問題，您也可以參考[AnythingLLM#RAG](AnyChatDoc.md#rag)或[RAGflow RAG聊天機器人](../RAGFlow/agents.md#背景)的說明：
...
- 公司內部也有許多API端口的範例，如[RAGflow](../RAGFlow/api.md)，提供RAGflow的代理服務、[AnythingLLM](AnyChat_adm.md#api-keys)也提供了**批次請求**的服務。
